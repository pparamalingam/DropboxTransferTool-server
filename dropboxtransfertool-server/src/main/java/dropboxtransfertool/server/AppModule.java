package dropboxtransfertool.server;
...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("4343321540155952604 dropboxtransfertool-server dropboxtransfertool-server a3548f46-eeb5-4547-82c7-ad5b8183c1b8".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in dropboxtransfertool.server package as a set of config entries
        return configLoader.fromResource("dropboxtransfertool/server/settings");
    }
